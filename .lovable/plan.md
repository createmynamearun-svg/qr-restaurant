...
Every hook connects directly to the live database via the Supabase client:
...
Used for live kitchen displays, waiter dashboards, admin previews, and super admin monitoring.
...
Both public-read with authenticated-write RLS.

---

## Summary

Everything is fully connected. The 33 migration files have built the complete schema. All 7 edge functions are deployed. All 30+ hooks query live data. Authentication with role-based routing is operational. No mock data is used anywhere — this is a production-ready multi-tenant SaaS backend. 

postgresql://postgres:[YOUR-PASSWORD]@db.qietzzrlzpbohuohzrkp.supabase.co:5432/postgres