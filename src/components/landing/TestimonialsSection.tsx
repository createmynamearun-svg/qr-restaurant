...
const testimonials = [
  ...
  {
    name: 'Vikram Patel',
    role: 'Chef, Tandoor Tales',
    content: 'The kitchen dashboard keeps my team in sync. We cut prep errors by 60% in the first month alone.',
    rating: 5,
    initials: 'VP',
    color: 'bg-green-500',
  },
  {
    name: 'Meera Joshi',
    role: 'Owner, Tea & Toast',
    content: 'The feedback system helped us improve our service. Happy customers now leave Google Reviews automatically!',
    rating: 5,
    initials: 'MJ',
    color: 'bg-amber-500',
  },
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            See what our customers have to say about QR Dine Pro.
          </p>
        </motion.div>
