    ...
    <footer className="bg-card border-t">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm mb-6">
              Transform your restaurant with QR-powered digital ordering. 
              Increase efficiency, reduce costs, delight customers.
            </p>
            {/* Social Links */}
          ...
          >
            ...
            <div className="mt-6 space-y-2 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                ...
                <span>support@qrdinepro.com</span>
              </div>
              <div className="flex items-center gap-2">
      ...
      <div className="border-t">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>© {currentYear} QR Dine Pro. All rights reserved.</p>
